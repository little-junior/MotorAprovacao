...
namespace MotorAprovacao.WebApi
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                x.SwaggerDoc("v1", new OpenApiInfo { Title = "motorAprova��o", Version = "v1" });
            ...
            //Injection suggestion required for partial delivery day 12 corrigir implementa��o dos using
